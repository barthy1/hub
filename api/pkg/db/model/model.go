...
type (
	...
	Platform struct {
		gorm.Model
		Name             string             `gorm:"not null;unique"`
		ResourceVersions []*ResourceVersion `gorm:"many2many:resource_platforms;"`
		Resource         []*Resource        `gorm:"many2many:version_platforms;"`
	}
	...
	ResourceVersion struct {
		...
		Resource            Resource
		ResourceID          uint
		Platforms           []*Platform `gorm:"many2many:version_platforms;"`
